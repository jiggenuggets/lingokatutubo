...
urlpatterns = [
    ...
    path(
        "accounts/login/",
        views.TranslatorLoginView.as_view(),
        name="login",
    ),
    ...
    path("translate/job/<uuid:job_id>/delete/", views.confirm_delete_job, name="job_delete_confirm"),
    path("translate/job/<uuid:job_id>/delete/confirm/", views.delete_job, name="job_delete"),
